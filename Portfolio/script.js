...
const PROJECTS = [
 ...
 images: [
  ...
  },
  {
    ...
    title: "Dreamers",
    type: "Album Cover",
    context: "Music Visual Identity",
    location: "Toronto, ON",
    format: "Digital",
    medium: "Digital",
    status: "C",
    filterKey: "Album Cover",
    images: [ "image 2.png"],
    imageLayout: "single",
    desc: "Album artwork design exploring the visual identity of a music release for Dreamers (JSTDREAM student). Developed through research, mood exploration, and visual experimentation to create a cover that reflects the artist’s sound, atmosphere, and narrative.",
    meta: [
